...
//                   <div className="text-sm">gvpavitraganesh@gmail.com</div>
//                 </div>
//               </a>
...
//                   <div className="text-sm">Pavitra03-stud</div>
//                 </div>
//               </a>

//               <a
//                 href="https://www.linkedin.com/in/pavitra-g-v-873572332?utm_source=share_via&utm_content=profile&utm_medium=member_android"
//                 target="_blank"
//                 rel="noreferrer"
//                 className="flex items-center gap-3 rounded-2xl bg-white/[0.04] border border-border px-4 py-3 hover:bg-white/[0.08] transition"
//               >
...
//                   <div className="text-sm">Pavitra G V</div>
//                 </div>
//               </a>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  type="text"
                  className="mt-1 w-full rounded-xl bg-white/[0.04] border border-border px-4 py-3 text-sm outline-none"
                  placeholder="Your name"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={5}
                className="mt-1 w-full rounded-xl bg-white/[0.04] border border-border px-4 py-3 text-sm outline-none resize-none"
            ...
            <button
              type="submit"
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-accent px-6 py-3 text-sm font-semibold text-primary-foreground hover:scale-[1.02] transition"
            >
              {sent ? "Message sent ✓" : (
                <>
