...
//             className="mt-10 flex flex-col sm:flex-row gap-3 items-center md:items-start justify-center md:justify-start"
//           >
//             <a
//               href="#projects"
...
//             className="mt-12 flex items-center justify-center md:justify-start gap-4 text-muted-foreground"
//           >
//             <a href="https://github.com/Pavitra03-stud" target="_blank" rel="noreferrer" className="hover:text-foreground transition">
//               <Github className="h-5 w-5" />
//             </a>
//             <span className="h-1 w-1 rounded-full bg-muted-foreground/40" />
//             <a href="https://www.linkedin.com/in/pavitra-g-v-873572332" target="_blank" rel="noreferrer" className="hover:text-foreground transition">
...
//         >
//           <div className="relative w-[320px] h-[320px] sm:w-[380px] sm:h-[380px] rounded-full overflow-hidden">
...
import { ArrowRight, Mail, Sparkles, Github, Linkedin } from "lucide-react";
import profile from "../../assets/profile.jpg";
import resume from "../../assets/resume.pdf"; // ✅ ADDED
        ...
        <div className="text-center md:text-left">
          ...
          >
            ...
            <a
              href={resume}
              download
              className="inline-flex items-center gap-2 rounded-full border border-border px-7 py-3.5 text-sm font-semibold hover:bg-white/10 transition"
            >
              Download Resume
            </a>
          </motion.div>
